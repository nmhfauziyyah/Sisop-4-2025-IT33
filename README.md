...
| `CMD ["sh", "-c", "mkdir -p /it24_host /antink_mount /var/log && touch /var/log/it24.log && chmod 666 /var/log/it24.log && ./antink /antink_mount -f"]` | Perintah yang dijalankan saat container start: |
